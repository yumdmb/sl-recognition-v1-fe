    ...
    return (
      <div className="container mx-auto py-8 max-w-4xl">
        <Alert variant="destructive">
          ...
          <AlertDescription>{error || 'Unable to load results.'}</AlertDescription>
        </Alert>
        <div className="mt-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <div>
              <Badge className={`${getProficiencyColor(proficiencyLevel)} text-white text-lg px-4 py-2`}>
                {proficiencyLevel}
              </Badge>
          ...
          {performanceAnalysis.insights.length > 0 && (
            <div className="mt-4 p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-2">
                {performanceAnalysis.insights.map((insight: string, index: number) => (

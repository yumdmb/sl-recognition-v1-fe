...
- [x] 2. Implement AuthContext provider
  - [x] 2.1 Create AuthContext with user state management
    ...
    - _Implementation: src/context/AuthContext.tsx_

  - [x] 2.2 Implement authentication methods
    ...
    - _Implementation: AuthContext methods - login, register, logout, resetPassword, updateUser, resendConfirmation_

  - [x] 2.3 Add role-based access control logic
    ...
    - _Implementation: AuthContext convertSupabaseUser function, (main)/layout.tsx auth guard_

- [x] 3. Build registration flow
  - [x] 3.1 Create registration page UI
    ...
    - _Implementation: src/app/auth/register/page.tsx (Basic validation, no Zod, no password strength indicator yet)_

  - [x] 3.2 Implement registration logic
    ...
    - _Implementation: src/app/auth/register/page.tsx handleSubmit function_

  - [x] 3.3 Create email verification flow
    ...
    - _Implementation: src/app/auth/callback/page.tsx, AuthContext resendConfirmation_

- [x] 4. Build login flow
  - [x] 4.1 Create login page UI
    - Build login form with email and password fields
    - Add "Forgot Password" and "Register" links
    - Implement form validation
    - _Requirements: FR-005 (3.1)_
    - _Implementation: src/app/auth/login/page.tsx_

  - [x] 4.2 Implement login logic
    ...
    - _Implementation: src/app/auth/login/page.tsx handleSubmit_

- [x] 5. Build password management
  - [x] 5.1 Create forgot password page
    - Build email input form
    - Implement password reset email sending
    - Show success message with instructions
    - _Requirements: FR-013 (6.1, 6.2)_
    - _Implementation: src/app/auth/forgot-password/page.tsx_
  ...
  - [x] 5.2 Create reset password page
    ...
    - _Implementation: src/app/auth/reset-password/page.tsx_
  ...
  - [ ] 5.3 Add change password functionality
    ...
    - _Note: Button exists in profile page but not yet functional_

- [x] 6. Build profile management
  - [x] 6.1 Create profile page UI
    - Display current user information (name, email, role)
    - Build edit profile form
    - Add save and cancel buttons
    - _Requirements: FR-010 (4.1, 4.2)_
    - _Implementation: src/app/(main)/profile/page.tsx (displays info, buttons exist but not wired)_
  ...
  - [ ] 6.2 Implement profile update logic
    ...
    - _Note: AuthContext.updateUser exists but not wired to profile page buttons_

- [x] 7. Implement route protection
  - [x] 7.1 Create middleware for authentication
    - Define protected and public routes
    - Check authentication status for protected routes
    - Redirect unauthenticated users to login
    - _Requirements: FR-005 (3.5), FR-014 (7.4)_
    - _Implementation: src/middleware.ts, src/utils/supabase/middleware.ts_

  - [x] 7.2 Add role-based route protection
    - Define admin-only routes
    - Check user role permissions
    - Redirect unauthorized users with error message
    - _Requirements: FR-022 (8.2, 8.3, 8.4)_
    - _Implementation: src/app/(main)/layout.tsx auth guard, role-based navigation in AppSidebar_

- [x] 8. Implement logout functionality
  - [x] 8.1 Add logout button to navigation
    - Create logout button component
    - Add confirmation dialog (optional)
    - _Requirements: FR-014 (7.1)_
    - _Implementation: AppSidebar component_

  - [x] 8.2 Implement logout logic
    - Call AuthContext signOut method
    - Clear session and authentication tokens
    - Redirect to landing page
    - _Requirements: FR-014 (7.1, 7.2, 7.3)_
    - _Implementation: AuthContext.logout method_
...
- [x] 9. Add error handling and validation
  - [x] 9.1 Implement form validation
    ...
    - _Implementation: Basic validation in all auth forms (no Zod yet, basic password validation)_

  - [x] 9.2 Add error boundaries and toast notifications
    - Create error boundary components
    - Implement toast notification system
    - Add user-friendly error messages
    - _Requirements: FR-001 (1.4, 1.5), FR-005 (3.4)_
    - _Implementation: Sonner toast notifications used throughout auth flows_

- [x] 10. Create user service layer
  - [x] 10.1 Build user profile service
    ...
    - _Implementation: src/lib/services/userService.ts_

  - [x] 10.2 Build authentication service
    ...
    - _Implementation: Utility methods in AuthContext, UserService.isAdmin_
